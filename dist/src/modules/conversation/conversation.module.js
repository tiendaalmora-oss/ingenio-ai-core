...
const media_processing_module_1 = require("../media-processing/media-processing.module");
let ConversationModule = class ConversationModule {
};
exports.ConversationModule = ConversationModule;
exports.ConversationModule = ConversationModule = __decorate([
    (0, common_1.Module)({
        imports: [outbound_engine_module_1.OutboundEngineModule, media_processing_module_1.MediaProcessingModule],
