...
export declare class MetaWebhookController {
    ...
    constructor(receiveMessageService: ReceiveMessageService, tenantResolver: TenantResolverService, prisma: PrismaService, audioTranscriptionService: AudioTranscriptionService, mediaVisionService: MediaVisionService, wahaAdapter: WahaAdapterService);
