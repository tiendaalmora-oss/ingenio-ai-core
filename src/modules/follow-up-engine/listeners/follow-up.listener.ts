...
export class FollowUpListenerService {
  ...
  async handleFollowUpPending(payload: any) {
    ...
    try {
      ...
      // Candado Anti-Fuga: Si el mensaje contiene nombres internos del sistema o trazas de error, anularlo
      if (finalMessage) {
      ...
      // Fallback seguro: Si la IA no generó texto o fue descartado, usar la instrucción de la regla o mensaje neutral garantizado
